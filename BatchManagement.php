    ...
    <body>
        ...
        <div class="contensection">
            ...
            <div class="dashsection">
                <div class="dashhead"><marquee>Batch Management</marquee></div>
                <div class="DashContent">
                 <div class="Dashmenu"><a href="batch_list.php">View</a></div>
                    <div class="Dashmenu"><a href="batch_create.php">Add</a></div>
                    <div class="Dashmenu"><a href="batch_edit_page.php">Update</a></div>
                    <div class="Dashmenu"><a href="batch_delete_page.php">Delete</a></div>
                </div>
            </div>
        </div>
        <div class="footer">
